...
This is a Google Chrome plugin that finds events at the amazing [[https://now-is.org]] and adds a button so that you can add them to your calendar (currently only supports google calendar API). 
